...
-   **Export Preparedness Index EPI** 2020 by NITI Top is Gujarat, Maha, TN. Challenges in ex promotion - Intra- inter regional disparities, poor trade support and R&D. Need : joint dev, industry academia linkage, create state level engagement, revamped design standard #report 
...
- **RDSS Revamped Distribution Sector #Scheme** is reforms based and results linked scheme to improve operational efficiencies and financials stability of all DISCOMs/Power dept excluding private sector.
	- Gives conditional financial assistance for supply infrastructure based on meeting pre qualifying criteria.
	- Compulsory smart metering ecosystem, major focus on improving supply for farmers and for providing daytime electricity.
...
-   State Sagarmala Committee headed by
Chief Minister/Minister in Charge of Ports
